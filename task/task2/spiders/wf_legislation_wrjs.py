...
class WrjsLegislationSpider(scrapy.Spider):
    name = 'wf_legislation_wrjs'

    def start_requests(self):
        for i in range(1, 189):
            url = "http://s.wanfangdata.com.cn/Claw.aspx?q=%E6%97%A0%E4%BA%BA%E9%A9%BE%E9%A9%B6&f=top&p=" + str(i)
