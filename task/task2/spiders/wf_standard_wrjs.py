...
class WrjsStandardSpider(scrapy.Spider):
    name = 'wf_standard_wrjs'

    def start_requests(self):
        for i in range(1, 7):
            url = "http://s.g.wanfangdata.com.cn/Standard.aspx?q=%E6%97%A0%E4%BA%BA%E9%A9%BE%E9%A9%B6&p=" + str(i)
            print(url)
